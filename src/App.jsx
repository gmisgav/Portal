...
const SECTION_IDS = ["economy","tournaments","missions","missions-v2","cashback","liveops"];

const SEED_USERS = [
  { id:1, email:"admin@company.com",   name:"Super Admin",   password:"admin123",  role:"superadmin",
    permissions:{economy:"admin",tournaments:"admin",missions:"admin","missions-v2":"admin",cashback:"admin",liveops:"admin"} },
  { id:2, email:"lead@company.com",    name:"LiveOps Lead",  password:"lead123",   role:"editor",
    permissions:{economy:"edit",tournaments:"edit",missions:"edit","missions-v2":"edit",cashback:"view",liveops:"view"} },
  { id:3, email:"analyst@company.com", name:"Data Analyst",  password:"analyst123",role:"viewer",
    permissions:{economy:"view",tournaments:"view",missions:"view","missions-v2":"view",cashback:"none",liveops:"none"} },
  { id:4, email:"junior@company.com",  name:"Junior Designer",password:"junior123",role:"viewer",
    permissions:{economy:"none",tournaments:"none",missions:"view","missions-v2":"view",cashback:"none",liveops:"none"} },
];
...
const FEATURES = [
  ...
  {id:"tournaments",icon:"🏆",label:"Tournaments",color:"#90cdf4",border:"#2c5282",bg:"#0d1a2e",status:"coming-soon",description:"Configure tournament schedules, prize pools, entry fees and leaderboard rules."},
...
function MissionsPage({ onBack, readOnly }) {
...
function MissionsV2Page({ onBack }) {
...
function PortalWithAuth({ currentUser, users, setUsers, onLogout, onOpenAdmin }) {
  ...
  if (active==="missions") return (
    <AccessGate sectionId="missions">
      <div><ViewOnlyBanner sectionId="missions"/><MissionsPage onBack={()=>setActive(null)} readOnly={!canEdit(sectionPerm("missions"))}/></div>
    </AccessGate>
  );
  if (active==="missions-v2") return (
    <AccessGate sectionId="missions-v2">
      <div><ViewOnlyBanner sectionId="missions-v2"/><MissionsV2Page onBack={()=>setActive(null)}/></div>
    </AccessGate>
  );
